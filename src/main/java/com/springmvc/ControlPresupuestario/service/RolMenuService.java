...
public class RolMenuService {
    ...
    // Para desplegar el menu asignado al usuario por Login
    ...
    // Para desplegar el menu asignado al usuario seleccionado
    ...
    // Para desplegar el menu de registros Vigentes, para ser asignados a un Rol
    public List<RolMenu> getRolMenusByRoleIdAsignar() { 
